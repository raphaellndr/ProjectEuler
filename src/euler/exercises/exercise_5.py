...
def smallest_number() -> int:
    """Function that returns the smallest positive number that is evenly divisible by all numbers
    from 1 to 20.
...
def exercise_5() -> None:
    """Exercise 5: smallest positive number that is evenly divisible by all numbers from 1 to 20."""
